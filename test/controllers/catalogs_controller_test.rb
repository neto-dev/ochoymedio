...
class CatalogsControllerTest < ActionController::TestCase
  ...
  test "should create catalog" do
    assert_difference('Catalog.count') do
      post :create, catalog: { category_id: @catalog.category_id, date: @catalog.date, description: @catalog.description, name: @catalog.name }
    end
  ...
  test "should update catalog" do
    patch :update, id: @catalog, catalog: { category_id: @catalog.category_id, date: @catalog.date, description: @catalog.description, name: @catalog.name }
    assert_redirected_to catalog_path(assigns(:catalog))
  end
